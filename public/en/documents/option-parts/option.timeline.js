window.__EC_DOC_option_timeline = {
  ...
  "checkpointStyle.animationEasing": {
    "desc": "\n\n<p>The easing effect of animation of <code class=\"codespan\">checkpoint</code> in <code class=\"codespan\">timeline</code> component. Refers to <a href=\"http://localhost:8086/echarts-website/examples/en/view.html?c=line-easing\" target=\"_blank\">easing sample</a> for different easing effects.</p>\n",
    "uiControl": {
      "type": "enum",
